...
namespace Better.Tweens.Runtime
{
    public static class AudioHighPassFilterExtensions
    {
        ...
        public static IEnumerable<ResonanceAudioHighPassFilterTween> TweensResonance(this IEnumerable<AudioHighPassFilter> self, float options, OptionsMode optionsMode = default)
        {
        ...
        public static IEnumerable<FrequencyAudioHighPassFilterTween> TweensFrequency(this IEnumerable<AudioHighPassFilter> self, float options, OptionsMode optionsMode = default)
        {
            // TODO: Add self validation
